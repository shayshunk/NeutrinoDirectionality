...
int main()
{
    ...
    //----------------------------------------------------
    {
       ...
       double phiRadErrBias = sqrt( pow(sigmaBias[0]*meanBias[1]/(meanBias[0]*meanBias[0]), 2) + pow(sigmaBias[1]/(meanBias[0]), 2) ) / (1 + pow(meanBias[1]/meanBias[0], 2)); 
       ...
       double thetaRadErrBias = sqrt( pow(sigmaBias[2]/sqrt(effIBDs)/sqrt(meanBias[0]*meanBias[0] + meanBias[1]*meanBias[1]), 2) + pow(meanBias[0]*meanBias[2]*sigmaBias[0]/(meanBias[0]*meanBias[0] + meanBias[1]*meanBias[1]), 2) + pow(meanBias[1]*meanBias[2]*sigmaBias[1]/(meanBias[0]*meanBias[0] + meanBias[1]*meanBias[1]), 2) ) / (1 + pow(meanBias[2]/sqrt(meanBias[0]*meanBias[0] + meanBias[1]*meanBias[1]), 2));
    ...
    //----------------------------------------------------
    {
       ...
       double phiRadErrBias = sqrt( pow(sigmaBias[1]*meanBias[1]/(meanBias[0]*meanBias[0]), 2) + pow(sigmaBias[0]/(meanBias[0]), 2) ) / (1 + pow(meanBias[1]/meanBias[0], 2)); 
