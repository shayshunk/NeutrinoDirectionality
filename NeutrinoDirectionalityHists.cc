            ...
            for( long i = 0; i < nentries; i++ )
            {
                ...
                for( unsigned int ivar = 0; ivar != vars.size(); ++ivar )
                {
                        ...
                        if( pseg == nseg || diff_index > 0 || diff_index < 0 )
                        {
                            ...
                            {
                                if( ReactorOn )
                                    h_data_CorOn[ivar]->Fill(diff_index, xRx);
                                else
                                    h_data_CorOff[ivar]->Fill(diff_index, xRx);
                            }
                            ...
                            {
                                if( ReactorOn )
                                    h_data_AccOn[ivar]->Fill(diff_index, xRx*xRx);
                                else
                                    h_data_AccOff[ivar]->Fill(diff_index, xRx*xRx);
                            }
                        }
